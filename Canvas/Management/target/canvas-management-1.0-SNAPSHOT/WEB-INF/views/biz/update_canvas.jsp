...
<div class="container">
    ...
    <form class="form-horizontal" action="/canvas/updateCanvas.do" method="post" enctype="multipart/form-data">
        <input type="hidden" name="canvasId"  value="${canvas.id}">

        <div class="form-group">
            <label for="name" class="col-sm-2 control-label">名${canvas.id} ${canvas.name}称 ：</label>
            <div class="col-sm-8">
